...
## Soy un encabezado juejue
el pepe 

y encerrando una palabra en 2 asteriscos genero un **bold** 

https://www.markdownguide.org/cheat-sheet/ aprendo mark down aqui kkkkkk 

## encargo para el 17 de abril 

- crear un repositorio en github y compartirlo en una tarea de canvas

- crear un archivo clase-03.md dentro de una carpeta clases

- ver alguna de las siguientes y comentarlas en el archivo clase
